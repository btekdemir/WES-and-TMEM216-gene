...
missense_variants1.to_csv("classification_output.csv")

aligned_filename = "500subtree_aligned_fasta.fas"
position_dict = map_mutation_positions.map_mutation_position(aligned_filename)
conservation_scores = pd.read_csv("output2.tsv", sep = "\t")
cons_score_list = known_mutations.mutation_pos_cons_score(position_list, position_dict, conservation_scores)
...
missense_variants2.to_csv("classification_output2.csv")


aligned_filename = "500_subtree_pruned.fas"
position_dict = map_mutation_positions.map_mutation_position(aligned_filename)
conservation_scores = pd.read_csv("output3.tsv", sep = "\t")
cons_score_list = known_mutations.mutation_pos_cons_score(position_list, position_dict, conservation_scores)
...
missense_variants3.to_csv("classification_output3.csv")
